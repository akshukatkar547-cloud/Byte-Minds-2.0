...
(function () {
  ...
  const discoveryLog = [];
  const storyFlags = { satellite: false, vespera: false, noxWarned: false, astra9: false };
  ...
  document.getElementById('continue-btn').addEventListener('click', () => {
    ...
    notify('CHAPTER 02 IN DEVELOPMENT \u2014 CONTINUE EXPLORING FREELY', 'discovery');
    document.getElementById('chapter-tag').textContent = 'CHAPTER 01 \u2014 COMPLETE';
    gameRunning = true;
  });
